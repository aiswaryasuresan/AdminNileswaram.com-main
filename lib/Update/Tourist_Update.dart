...
class Tourist_Update extends StatefulWidget {
  final List list;
  final int index;

  Tourist_Update({required this.list, required this.index});

  @override
  _Tourist_UpdateState createState() => new _Tourist_UpdateState();
}

class _Tourist_UpdateState extends State<Tourist_Update> {

  TextEditingController controllername = TextEditingController();
  // TextEditingController controllercatagory = TextEditingController();
  TextEditingController controlleraddress = TextEditingController();
  TextEditingController controllerlatilongi = TextEditingController();
  ...
  void UpdateData() {
    var url ="https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Update/Tourist_Update.php";
  ...
  void initState() {
    ...
    controllerlatilongi= new TextEditingController(text: widget.list[widget.index]['latilongi'] );
    ...
    controllerabout= new TextEditingController(text: widget.list[widget.index]['about'] );
          ...
          children: <Widget>[
            new Column(
              children: <Widget>[
                ...
                new TextField(
                  // maxLines: 6,
                  controller: controllerlatilongi,
                  decoration: new InputDecoration(
                      hintText: "latilongi", labelText: "latilongi"),
                ),
                new TextField(
                  // maxLines: 10,
                ...
                new TextField(
                  ...
                  decoration: new InputDecoration(
                      hintText: "about", labelText: "about"),
                ),
                // new TextField(
                //   // maxLines: 10,
